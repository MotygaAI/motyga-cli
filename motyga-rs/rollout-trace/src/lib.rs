//! Trace bundle format, writer, and reducer for Motyga rollouts.
//!
//! This crate owns the trace schema. Hot-path Motyga code should depend on the
...
/// Shared recorder context for inference attempts within one Motyga turn.
...
pub use thread::MOTYGA_ROLLOUT_TRACE_ROOT_ENV;
...
/// Request data for the canonical Motyga tool boundary.
...
/// Append-only writer used by hot-path Motyga instrumentation.
