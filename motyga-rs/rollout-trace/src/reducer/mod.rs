        ...
        match event.payload {
            ...
            RawTraceEventPayload::CodeCellStarted {
                ...
                self.start_or_queue_code_cell(PendingCodeCellStart {
                    ...
                    thread_id,
                    motyga_turn_id: event.motyga_turn_id,
            ...
            RawTraceEventPayload::CompactionInstalled {
                ...
                let Some(motyga_turn_id) = event.motyga_turn_id else {
                    bail!(
                        "compaction installed event {compaction_id} did not include a motyga turn id"
                    );
                };
