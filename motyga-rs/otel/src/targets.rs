pub(crate) const OTEL_TARGET_PREFIX: &str = "motyga_otel";
pub(crate) const OTEL_LOG_ONLY_TARGET: &str = "motyga_otel.log_only";
pub(crate) const OTEL_TRACE_SAFE_TARGET: &str = "motyga_otel.trace_safe";
