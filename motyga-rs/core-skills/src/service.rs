...
impl SkillsService {
    pub fn new(motyga_home: AbsolutePathBuf, bundled_skills_enabled: bool) -> Self {
        Self::new_with_restriction_product(motyga_home, bundled_skills_enabled, Some(Product::Motyga))
    }
    ...
    pub fn new_with_restriction_product(
        ...
        if !bundled_skills_enabled {
            ...
            uninstall_system_skills(&service.motyga_home);
        } else if let Err(err) = install_system_skills(&service.motyga_home) {
...
pub fn bundled_skills_enabled_from_stack(
    config_layer_stack: &motyga_config::ConfigLayerStack,
) -> bool {
