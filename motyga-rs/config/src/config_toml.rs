...
/// Base config deserialized from ~/.motyga/config.toml.
...
pub struct ConfigToml {
    ...
    /// Optional product SKU forwarded on host-owned Motyga apps MCP requests.
    ...
    /// directories for `.motyga` folders. Defaults to [".git"] when unset.
    #[serde(default)]
