...
//!
//! RMCP clients call into this module when a server asks Motyga to elicit data
//! from the user. It decides whether the request can be automatically accepted,
//! must be declined by policy, or should be surfaced as a Motyga protocol event
...
use motyga_rmcp_client::SendElicitation;
...
/// generated by Motyga rather than copied from the MCP connection, so separate runtimes may reuse
