...
use motyga_protocol::protocol::HookEventName as CoreHookEventName;
use motyga_protocol::protocol::HookExecutionMode as CoreHookExecutionMode;
use motyga_protocol::protocol::HookHandlerType as CoreHookHandlerType;
use motyga_protocol::protocol::HookOutputEntry as CoreHookOutputEntry;
use motyga_protocol::protocol::HookOutputEntryKind as CoreHookOutputEntryKind;
use motyga_protocol::protocol::HookRunStatus as CoreHookRunStatus;
use motyga_protocol::protocol::HookRunSummary as CoreHookRunSummary;
use motyga_protocol::protocol::HookScope as CoreHookScope;
use motyga_protocol::protocol::HookSource as CoreHookSource;
use motyga_protocol::protocol::HookTrustStatus as CoreHookTrustStatus;
