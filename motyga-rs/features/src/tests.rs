...
#[test]
fn motyga_hooks_is_legacy_alias_for_hooks() {
    assert_eq!(feature_for_key("hooks"), Some(Feature::MotygaHooks));
    assert_eq!(feature_for_key("motyga_hooks"), Some(Feature::MotygaHooks));
}
