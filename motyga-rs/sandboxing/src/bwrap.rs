...
const USER_NAMESPACE_WARNING: &str =
    "Motyga's Linux sandbox uses bubblewrap and needs access to create user namespaces.";
pub(crate) const WSL1_BWRAP_WARNING: &str = concat!(
    "Motyga's Linux sandbox uses bubblewrap, which is not supported on WSL1 ",
