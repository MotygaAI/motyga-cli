...
pub(super) fn ensure_motyga_app_runtime_paths_readable(
    ...
    let motyga_root = local_app_data.join("OpenAI").join("Motyga");

    for runtime_path in [motyga_root.join("bin"), motyga_root.join("runtimes")] {
