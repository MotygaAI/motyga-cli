...
Generic transport layer that wraps HTTP requests, retries, and streaming primitives without any Motyga/OpenAI awareness.
...
- Consumed by higher-level crates like `motyga-api`; it stays neutral on endpoints, headers, or API-specific error shapes.
