use crate::default_client::MotygaHttpClient;
use crate::default_client::MotygaRequestBuilder;
...
impl ReqwestTransport {
    pub fn new(client: reqwest::Client) -> Self {
        Self {
            client: MotygaHttpClient::new(client),
        }
    }

    fn build(&self, req: Request) -> Result<MotygaRequestBuilder, TransportError> {
