...
use motyga_protocol::protocol::ThreadMemoryMode as MemoryMode;
...
pub struct CreateThreadParams {
    ...
    /// Thread id generated by Motyga before opening persistence.
...
mod tests {
    ...
    fn session_meta(history_mode: ThreadHistoryMode) -> RolloutItem {
        RolloutItem::SessionMeta(motyga_protocol::protocol::SessionMetaLine {
