...
use motyga_extension_api::ThreadIdleInput;
...
use motyga_extension_api::ToolLifecycleFuture;
use motyga_extension_api::TurnAbortInput;
    ...
    fn on_turn_error<'a>(&'a self, input: TurnErrorInput<'a>) -> ExtensionFuture<'a, ()> {
        Box::pin(async move {
            ...
            let reason = match input.error {
                MotygaErrorInfo::UsageLimitExceeded => ActiveGoalStopReason::UsageLimit,
