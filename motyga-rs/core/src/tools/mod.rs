...
) -> motyga_tools::ToolUserShellType {
    match user_shell.shell_type {
        crate::shell::ShellType::Zsh => motyga_tools::ToolUserShellType::Zsh,
        crate::shell::ShellType::Bash => motyga_tools::ToolUserShellType::Bash,
        crate::shell::ShellType::PowerShell => motyga_tools::ToolUserShellType::PowerShell,
        crate::shell::ShellType::Sh => motyga_tools::ToolUserShellType::Sh,
        crate::shell::ShellType::Cmd => motyga_tools::ToolUserShellType::Cmd,
    }
}
