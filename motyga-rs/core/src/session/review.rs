...
pub(super) async fn spawn_review_thread(
    ...
    let unified_exec_shell_mode = UnifiedExecShellMode::for_session(
        motyga_tools::unified_exec_feature_mode_for_features(review_features.get()),
    ...
    per_turn_config.permissions.shell_environment_policy = parent_turn_context
        ...
        .clone();
    per_turn_config.motyga_linux_sandbox_exe =
        parent_turn_context.config.motyga_linux_sandbox_exe.clone();
    ...
    let extension_data = Arc::new(motyga_extension_api::ExtensionData::new(
        review_turn_id.clone(),
    ));
