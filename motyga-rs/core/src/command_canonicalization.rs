use motyga_shell_command::bash::extract_bash_command;
use motyga_shell_command::bash::parse_shell_lc_plain_commands;
use motyga_shell_command::powershell::extract_powershell_command;

const CANONICAL_BASH_SCRIPT_PREFIX: &str = "__motyga_shell_script__";
const CANONICAL_POWERSHELL_SCRIPT_PREFIX: &str = "__motyga_powershell_script__";
