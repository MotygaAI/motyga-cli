...
//! `EscalateRequest` over the inherited `MOTYGA_ESCALATE_SOCKET`, and the server decides whether to
...
//! specified by the `MOTYGA_ESCALATE_SOCKET` environment variable to _send_ escalation requests,
...
pub use motyga_protocol::approvals::EscalationPermissions;
pub use motyga_protocol::approvals::ResolvedPermissionProfile;
