use motyga_collaboration_mode_templates::DEFAULT as COLLABORATION_MODE_DEFAULT;
use motyga_collaboration_mode_templates::PLAN as COLLABORATION_MODE_PLAN;
use motyga_protocol::config_types::CollaborationModeMask;
use motyga_protocol::config_types::ModeKind;
use motyga_protocol::config_types::TUI_VISIBLE_COLLABORATION_MODES;
