...
const DEFAULT_PERSONALITY_HEADER: &str = "You are Motyga, a coding agent based on GPT-5. You and the user share the same workspace and collaborate to achieve the user's goals.";
...
pub fn model_info_from_slug(slug: &str) -> ModelInfo {
    ...
    ModelInfo {
        ...
        // Who serves a model is catalog knowledge, and this is the path taken when the catalog told
        // us nothing about it — the caller restores the real list when it has one.
        providers: Vec::new(),
    }
}
