...
use motyga_app_server_protocol::RemoteControlDisableParams;
use motyga_app_server_protocol::RemoteControlDisableResponse;
use motyga_app_server_protocol::RemoteControlEnableParams;
...
async fn connect_with_retry(
    ...
    connect_timeout: Duration,
    connect_retry_delay: Duration,
) -> Result<WebSocketStream<motyga_uds::UnixStream>> {
...
mod tests {
    ...
    const TEST_MOTYGA_HOME: &str = "/tmp/motyga-home";
        ...
        client::send_message(
            ...
            &JSONRPCMessage::Response(JSONRPCResponse {
                ...
                result: serde_json::json!({
                    "userAgent": "motyga_app_server/1.2.3",
                    "motygaHome": TEST_MOTYGA_HOME,
                    "platformFamily": "unix",
                    "platformOs": "macos",
                }),
            }),
