...
const MULTIPART_BOUNDARY: &str = "motyga-realtime-call-boundary";
const MULTIPART_CONTENT_TYPE: &str = "multipart/form-data; boundary=motyga-realtime-call-boundary";
...
impl<T: HttpTransport> RealtimeCallClient<T> {
    ...
    pub async fn create_with_session_and_headers(
        ...
        trace!(target: "motyga_api::realtime_websocket::wire", "realtime call request SDP: {sdp}");
