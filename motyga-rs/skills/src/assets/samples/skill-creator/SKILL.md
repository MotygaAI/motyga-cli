...
- "Where should I create this skill? If you do not have a preference, I will place it in `$MOTYGA_HOME/skills` (or `~/.motyga/skills` when `MOTYGA_HOME` is unset) so Codex can discover it automatically."
