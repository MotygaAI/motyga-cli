...
Set a stable path to the skill CLI (default `MOTYGA_HOME` is `~/.motyga`):

```
export MOTYGA_HOME="${MOTYGA_HOME:-$HOME/.motyga}"
export IMAGE_GEN="$MOTYGA_HOME/skills/.system/imagegen/scripts/image_gen.py"
```
