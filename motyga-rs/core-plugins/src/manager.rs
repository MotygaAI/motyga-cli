...
impl PluginsManager {
    ...
    pub fn new_with_options(
        ...
        // Product restrictions are enforced at marketplace admission time for a given MOTYGA_HOME:
        ...
        // contents of that MOTYGA_HOME and does not re-filter configured plugins by product, so
