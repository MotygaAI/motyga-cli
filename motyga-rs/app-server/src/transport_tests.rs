    ...
    route_outgoing_envelope(
        ...
        OutgoingEnvelope::ToConnection {
            ...
            message: OutgoingMessage::Request(ServerRequest::CommandExecutionRequestApproval {
                ...
                params: motyga_app_server_protocol::CommandExecutionRequestApprovalParams {
                    ...
                    additional_permissions: Some(
                        motyga_app_server_protocol::AdditionalPermissionProfile {
                            network: None,
                            file_system: Some(
                                motyga_app_server_protocol::AdditionalFileSystemPermissions {
