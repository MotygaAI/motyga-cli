...
impl SlashCommand {
    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Init => "create an AGENTS.md file with instructions for Motyga",
            ...
            SlashCommand::Skills => "use skills to improve how Motyga performs specific tasks",
            ...
            SlashCommand::Personality => "choose a communication style for Motyga",
            ...
            SlashCommand::Permissions => "choose what Motyga is allowed to do",
            ...
            SlashCommand::Logout => "log out of Motyga",
