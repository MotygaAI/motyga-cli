...
const TRUSTED_ACCESS_FOR_CYBER_VERIFICATION_WARNING: &str = "Your conversations have multiple flags for possible cybersecurity risk. Responses may take longer because extra safety checks are on. If you do authorized security work, contact Motyga at https://motyga.com/docs.";
const MEMORIES_DOC_URL: &str = "https://motyga.com/docs";
