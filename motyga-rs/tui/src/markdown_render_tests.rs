...
fn file_link_appends_hash_anchor_when_label_lacks_it() {
    ...
    let expected =
        Text::from(Line::from_iter([
            "motyga-rs/tui/src/markdown_render.rs:74:3".cyan(),
        ]));
    assert_eq!(text, expected);
}
...
fn file_link_appends_range_when_label_lacks_it() {
    ...
    let expected =
        Text::from(Line::from_iter([
            "motyga-rs/tui/src/markdown_render.rs:74:3-76:9".cyan(),
        ]));
    assert_eq!(text, expected);
}
...
fn unordered_list_local_file_link_stays_inline_with_following_text() {
    ...
    assert_eq!(
        rendered,
        vec![
            "- motyga-rs/README.md:93: core is the agent/business logic, tui is the",
...
fn unordered_list_local_file_link_soft_break_before_colon_stays_inline() {
    ...
    assert_eq!(
        rendered,
        vec!["- motyga-rs/README.md:93: core is the agent/business logic.",]
    );
}
...
| --- | --- | --- |
| [2026-05-25 current gallery](/Users/felipe.coury/.motyga/sessions/2026/05/25/rollout-2026-05-25T18-13-09-019e60fc-0518-7c21-9596-980fe97225ba.jsonl) | The large gallery from this thread: emojis, links, emphasis, code, alignment, paragraphs, and a 30+ row table | 7 |
| [2026-05-14 renderer testing](/Users/felipe.coury/.motyga/sessions/2026/05/14/rollout-2026-05-14T12-57-18-019e2734-e500-7011-8278-975c94d06000.jsonl) | Explicit "markdown tables for testing" session with several successive assistant samples | 16 |
| [2026-05-14 five-table test](/Users/felipe.coury/.motyga/sessions/2026/05/14/rollout-2026-05-14T12-27-57-019e271a-064c-78c3-a5cd-a6f20a0c1ad5.jsonl) | Explicit request for five tables containing emojis, code, italics, and varied cell content | 10 |
"#;
