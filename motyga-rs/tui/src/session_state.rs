...
pub(crate) struct ThreadSessionState {
    ...
    pub(crate) approvals_reviewer: motyga_protocol::config_types::ApprovalsReviewer,
    ...
    pub(crate) reasoning_effort: Option<motyga_protocol::openai_models::ReasoningEffort>,
