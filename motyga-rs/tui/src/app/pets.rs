...
impl App {
    ...
    pub(super) fn handle_pet_selected(&mut self, tui: &mut tui::Tui, pet_id: String) {
        ...
        std::mem::drop(tokio::task::spawn_blocking(move || {
            let result = crate::pets::ensure_builtin_pack_for_pet(&pet_id, &motyga_home)
                .and_then(|()| {
    ...
    pub(super) async fn handle_pet_disabled(&mut self, tui: &mut tui::Tui) {
        ...
        let apply_result = ConfigEditsBuilder::new(&self.config.motyga_home)
            .with_edits([edit])
            .apply()
            .await;
        match apply_result {
    ...
    pub(super) async fn handle_pet_selection_loaded(
        ...
        match result {
            Ok(ambient_pet) => {
                ...
                match ConfigEditsBuilder::new(&self.config.motyga_home)
                    .with_edits([edit])
                    .apply()
                    .await
                {
