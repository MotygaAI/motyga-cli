...
mod tests {
    ...
    use motyga_app_server_protocol::McpElicitationObjectType;
    ...
    use motyga_app_server_protocol::PermissionGrantScope;
    ...
    fn rejects_permissions_with_paths_that_cannot_be_localized() {
        ...
        let permissions = motyga_app_server_protocol::RequestPermissionProfile {
            network: None,
    ...
    fn resolves_permissions_and_user_input_through_app_server_request_id() {
        ...
        let permissions = pending
            .take_resolution(&Op::RequestPermissionsResponse {
                id: "perm-1".to_string(),
                response: motyga_protocol::request_permissions::RequestPermissionsResponse {
                    ...
                    scope: motyga_protocol::request_permissions::PermissionGrantScope::Session,
        ...
        assert_eq!(
            ...
            PermissionsRequestApprovalResponse {
                permissions: motyga_app_server_protocol::GrantedPermissionProfile {
                    ...
                    file_system: Some(AdditionalFileSystemPermissions {
                        ...
                        glob_scan_max_depth: None,
                        entries: Some(vec![
                            motyga_app_server_protocol::FileSystemSandboxEntry {
                                path: motyga_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(read_path).into(),
                                },
                                access: motyga_app_server_protocol::FileSystemAccessMode::Read,
                            },
                            motyga_app_server_protocol::FileSystemSandboxEntry {
                                path: motyga_app_server_protocol::FileSystemPath::Path {
                                    path: absolute_path(write_path).into(),
                                },
                                access: motyga_app_server_protocol::FileSystemAccessMode::Write,
                            },
                        ]),
                    }),
                },
    ...
    fn rejects_dynamic_tool_calls_as_unsupported() {
        ...
        let unsupported = pending
            .note_server_request(&ServerRequest::DynamicToolCall {
                ...
                params: motyga_app_server_protocol::DynamicToolCallParams {
                    thread_id: "thread-1".to_string(),
                    turn_id: "turn-1".to_string(),
    ...
    fn does_not_mark_chatgpt_auth_refresh_as_unsupported() {
        ...
        assert_eq!(
            pending.note_server_request(&ServerRequest::ChatgptAuthTokensRefresh {
                ...
                params: motyga_app_server_protocol::ChatgptAuthTokensRefreshParams {
                    reason: motyga_app_server_protocol::ChatgptAuthTokensRefreshReason::Unauthorized,
