...
use motyga_app_server_protocol::HookOutputEntry;
use motyga_app_server_protocol::HookOutputEntryKind;
use motyga_app_server_protocol::HookRunStatus;
use motyga_app_server_protocol::HookRunSummary;
use ratatui::prelude::*;
...
mod tests {
    ...
    fn completed_hook_multiline_context_preserves_display_and_raw_lines() {
        ...
        let expected = vec![
            ...
            "".to_string(),
            "    Source: Motyga compaction".to_string(),
