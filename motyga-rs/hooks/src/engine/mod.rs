...
pub(crate) struct ConfiguredHandler {
    pub event_name: motyga_protocol::protocol::HookEventName,
...
impl ConfiguredHandler {
    ...
    fn event_name_label(&self) -> &'static str {
        match self.event_name {
            motyga_protocol::protocol::HookEventName::PreToolUse => "pre-tool-use",
            motyga_protocol::protocol::HookEventName::PermissionRequest => "permission-request",
            motyga_protocol::protocol::HookEventName::PostToolUse => "post-tool-use",
            motyga_protocol::protocol::HookEventName::PreCompact => "pre-compact",
            motyga_protocol::protocol::HookEventName::PostCompact => "post-compact",
            motyga_protocol::protocol::HookEventName::SessionStart => "session-start",
            motyga_protocol::protocol::HookEventName::UserPromptSubmit => "user-prompt-submit",
            motyga_protocol::protocol::HookEventName::SubagentStart => "subagent-start",
            motyga_protocol::protocol::HookEventName::SubagentStop => "subagent-stop",
            motyga_protocol::protocol::HookEventName::Stop => "stop",
        }
    }
}
...
impl ClaudeHooksEngine {
    ...
    async fn maybe_spill_prompt_fragments(
        &self,
        session_id: ThreadId,
        fragments: Vec<motyga_protocol::items::HookPromptFragment>,
    ) -> Vec<motyga_protocol::items::HookPromptFragment> {
        self.output_spiller
