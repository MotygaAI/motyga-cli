//! Shared model metadata types exchanged between Motyga services and clients.
//!
...
/// Metadata describing a Motyga-supported model.
#[derive(Debug, Clone, Deserialize, Serialize, TS, JsonSchema, PartialEq)]
...
/// Model metadata returned by the Motyga backend `/models` endpoint.
