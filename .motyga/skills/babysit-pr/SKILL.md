...
```bash
python3 .motyga/skills/babysit-pr/scripts/gh_pr_watch.py --pr auto --once
```

### Continuous watch (JSONL)

```bash
python3 .motyga/skills/babysit-pr/scripts/gh_pr_watch.py --pr auto --watch
```

### Trigger flaky retry cycle (only when watcher indicates)

```bash
python3 .motyga/skills/babysit-pr/scripts/gh_pr_watch.py --pr auto --retry-failed-now
```

### Explicit PR target

```bash
python3 .motyga/skills/babysit-pr/scripts/gh_pr_watch.py --pr <number-or-url> --once
```
...
Read `.motyga/skills/babysit-pr/references/heuristics.md` for a concise checklist.
...
- Heuristics and decision tree: `.motyga/skills/babysit-pr/references/heuristics.md`
- GitHub CLI/API details used by the watcher: `.motyga/skills/babysit-pr/references/github-api-notes.md`
