...
PACKAGE_VARIANTS: dict[str, PackageVariant] = {
    "motyga": PackageVariant(
        name="motyga",
        cargo_bin="motyga",
        executable_stem="motyga",
    ),
    "motyga-app-server": PackageVariant(
        name="motyga-app-server",
        cargo_bin="motyga-app-server",
        executable_stem="motyga-app-server",
    ),
}
