...
docker run --platform=linux/amd64 --rm -it -e CARGO_TARGET_DIR=/workspace/motyga-rs/target-amd64 -v "$PWD":/workspace -w /workspace/motyga-rs "$CODEX_DOCKER_IMAGE_NAME"
```
