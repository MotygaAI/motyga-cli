...
Thank you for helping us keep Motyga secure!
...
## How to operate MOTYGA safely

For details on Motyga security boundaries, including sandboxing, approvals, and network controls, see [Agent approvals & security](https://developers.openai.com/codex/agent-approvals-security).
