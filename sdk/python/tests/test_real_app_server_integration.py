...
RUN_REAL_MOTYGA_TESTS = os.environ.get("RUN_REAL_MOTYGA_TESTS") == "1"
pytestmark = pytest.mark.skipif(
    not RUN_REAL_MOTYGA_TESTS,
    reason="set RUN_REAL_MOTYGA_TESTS=1 to run real Motyga integration coverage",
)
...
def runtime_env(tmp_path_factory: pytest.TempPathFactory) -> PreparedRuntimeEnv:
    ...
    env["MOTYGA_PYTHON_SDK_DIR"] = str(ROOT)
