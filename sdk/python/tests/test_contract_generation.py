...
GENERATED_TARGETS = [
    Path("src/motyga_sdk/generated/notification_registry.py"),
    Path("src/motyga_sdk/generated/v2_all.py"),
    Path("src/motyga_sdk/api.py"),
]
...
def test_generated_files_are_up_to_date():
    ...
    assert importlib.metadata.version("motyga-cli-bin") == "0.137.0a4"
    env = os.environ.copy()
    env.pop("MOTYGA_EXEC_PATH", None)
