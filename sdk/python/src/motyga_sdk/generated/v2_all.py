...
#   filename:  motyga_app_server_protocol.v2.schemas.json
...
class MotygaAppServerProtocolV2(BaseModel):
    pass
...
class MotygaErrorInfoValue(Enum):
...
class HttpConnectionFailedMotygaErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamConnectionFailedMotygaErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseStreamDisconnectedMotygaErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ResponseTooManyFailedAttemptsMotygaErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class ProjectConfigLayerSource(BaseModel):
    ...
    dot_motyga_folder: Annotated[AbsolutePathBuf, Field(alias="dotMotygaFolder")]
...
class ExternalAgentConfigDetectParams(BaseModel):
    ...
    include_home: Annotated[
        ...
        Field(
            alias="includeHome",
            description="If true, include detection under the user's home (~/.claude, ~/.motyga, etc.).",
        ),
    ] = None
...
class ChatgptLoginAccountParams(BaseModel):
    ...
    motyga_streamlined_login: Annotated[bool | None, Field(alias="motygaStreamlinedLogin")] = None
...
class ChatgptAuthTokensLoginAccountParams(BaseModel):
    ...
    chatgpt_plan_type: Annotated[
        ...
        Field(
            ...
            description="Optional plan type supplied by the client.\n\nWhen `null`, Motyga attempts to derive the plan type from access-token claims. If unavailable, the plan defaults to `unknown`.",
        ),
    ] = None
    type: Annotated[
...
class ThreadApproveGuardianDeniedActionParams(BaseModel):
    ...
    event: Annotated[
        Any, Field(description="Serialized `motyga_protocol::protocol::GuardianAssessmentEvent`.")
    ]
    thread_id: Annotated[str, Field(alias="threadId")]
...
class ActiveTurnNotSteerableMotygaErrorInfo(BaseModel):
    model_config = ConfigDict(
        extra="forbid",
        populate_by_name=True,
    )
...
class MotygaErrorInfo(
    RootModel[
        MotygaErrorInfoValue
        | HttpConnectionFailedMotygaErrorInfo
        | ResponseStreamConnectionFailedMotygaErrorInfo
        | ResponseStreamDisconnectedMotygaErrorInfo
        | ResponseTooManyFailedAttemptsMotygaErrorInfo
        | ActiveTurnNotSteerableMotygaErrorInfo
    ]
):
    model_config = ConfigDict(
        populate_by_name=True,
...
class TurnError(BaseModel):
    ...
    motyga_error_info: Annotated[MotygaErrorInfo | None, Field(alias="motygaErrorInfo")] = None
    message: str
...
class GetAccountRateLimitsResponse(BaseModel):
    ...
    rate_limits_by_limit_id: Annotated[
        ...
        Field(
            ...
            description="Multi-bucket view keyed by metered `limit_id` (for example, `motyga`).",
        ),
    ] = None
...
class Thread(BaseModel):
    ...
    source: Annotated[
        SessionSource,
        Field(
            description="Origin of the thread (CLI, VSCode, motyga exec, motyga app-server, etc.)."
        ),
    ]
